    ...
    <footer className="bg-gray-900 dark:bg-gray-950 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a
                  href="https://github.com/pedronicolasg/OceanBreeze"
                  className="text-gray-400 hover:text-white transition-colors"
                >
                  Sobre Nós
                </a>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li>
                <a
                  href="mailto:contato@oceanbreeze.com.br"
                  className="hover:text-white transition-colors"
                >
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">© 2025 Ocean Breeze.</p>
          <a
            href="https://github.com/pedronicolasg/OceanBreeze"
            target="_blank"
            className="text-gray-400 text-sm flex items-center mt-2 md:mt-0"
          >
            Desenvolvido com <Heart className="w-4 h-4 mx-1 text-blue-500" />{" "}
